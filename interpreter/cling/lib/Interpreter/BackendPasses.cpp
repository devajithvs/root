  ...
  switch (Opts.OptimizationLevel) {
    ...
    case 2:
      switch (Opts.OptimizeSize) {
        ...
        case 0: return PassBuilder::OptimizationLevel::O2;

        case 1: return PassBuilder::OptimizationLevel::Os;

        case 2: return PassBuilder::OptimizationLevel::Oz;
      }

    case 3: return PassBuilder::OptimizationLevel::O3;
  }
}
...
void BackendPasses::CreatePasses(int OptLevel, llvm::ModulePassManager& MPM,
  ...
  if (!m_CGOpts.DisableLLVMPasses) {
    ...
    PassBuilder::OptimizationLevel Level = mapToLevel(m_CGOpts);
...
void BackendPasses::runOnModule(Module& M, int OptLevel) {
  ...
  PassInstrumentationCallbacks PIC;
  StandardInstrumentations SI(m_CGOpts.DebugPassManager);
