...
namespace cling {
  ...
  void StartParsingRAII::prepareForParsing(llvm::StringRef code,
    ...
    // This restores old (LLVM 18) behavior: error -> ExprError (invalid), without a "recoverable" initializer that later trips CodeGen.
    // Happens post: https://github.com/llvm/llvm-project/commit/fd87d765c0455265aea4595a3741a96b4c078fbc
    //
