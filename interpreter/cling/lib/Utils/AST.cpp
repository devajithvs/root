...
NestedNameSpecifier getFullyQualifiedNestedNameSpecifier(
  ...
  case NestedNameSpecifier::Kind::Type: {
    ...
    if (const TagType *TagDeclType = Type->getAs<TagType>())
      ...
      return Scope;
    return createNestedNameSpecifier(Ctx, TD, /*FullyQualify=*/true,
                                               WithGlobalNsPrefix);
  }
  }
...
namespace utils {
  static bool GetFullyQualifiedTemplateName(const ASTContext& Ctx,
                                            TemplateName& tname) {
    return getFullyQualifiedTemplateName(
      ...
      if (outer_scope) {
        ...
        if (const auto *TT = dyn_cast<TagType>(desugared.getTypePtr())) {
          ...
          desugared = Ctx.getTypedefType(
              ...
              getFullyQualifiedType(TT->desugar(), Ctx, /*WithGlobalNsPrefix=*/false));
        }
      }
