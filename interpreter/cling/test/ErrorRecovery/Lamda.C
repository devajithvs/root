...
// expected-error {{'Var' cannot be captured because it does not have automatic storage duration}}
// expected-note {{'Var' declared here}}
// expected-warning {{captures will be by reference, not copy}}
