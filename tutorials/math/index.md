...
| mathcoreGenVectorSYCL.C | Example macro testing available methods and operation of the GenVectorX classes to be used in SYCL or CUDA kernels for heterogeneous computing. |
